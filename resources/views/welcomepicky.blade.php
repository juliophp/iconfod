  ...
  <ol class="carousel-indicators">
    ...
    <div class="carousel-inner" style="height:600px; !important">
      <div class="carousel-item active">
        <img class="d-block w-100" src="{{ asset('images/image01.jpg')}}" alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="{{ asset('images/belegija.jpg')}}" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="{{ asset('images/xiang.jpg')}}" alt="Third slide">
      </div>
    </div>
...
<div class="location-match text-xs-center">
    <div class="container"> <span>6 restaurants matched your location: <select class="form-control"><option>New York, NY </option></select></span>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="{{ asset('storage/'.$menu->image) }}">
                                <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                                <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="review pull-right"><a href="#">198 reviews</a> </div>
                            </div>
                            <div class="content">
                                <h5><a href="#">{{$menu->menuname}}</a></h5>
                            ...
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="{{route('resprofile', $menu->restaurant->id)}}"> <img src="{{ asset('storage/'.$menu->restaurant->profile) }}" width="50" height="50" alt="Restaurant logo" /> </a>
                                    <div class="pull-left right-text"> <a href="{{route('resprofile',$menu->restaurant->id)}}">{{ $menu->restaurant->name}}</a> <span>{{ str_limit($menu->restaurant->address, 20) }}</span> </div>
                                </div>
...
<!-- Popular block ends -->
<div class="location-match text-xs-center">
    <div class="container"> <span>See <a href="{{ route('restaurants')}}"><span class="primary-color">All Restaurants</span> </a></span>
    </div>
</div>
                    ...
                    <div class="restaurant-wrap">
                        <div class="row">
                            <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                <a class="restaurant-logo" href="{{ route('resprofile', $restaurant->id)}}"> <img src="{{ asset('storage/'.$restaurant->profile) }}" alt="Restaurant logo"> </a>
                            </div>
                            <!--end:col -->
                            <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                <h5><a href="{{ route('resprofile', $restaurant->id)}}">{{ $restaurant->name }}</a></h5> <span>Burgers, American, Sandwiches, Fast Food, BBQ</span>
                                <div class="bottom-part">
                                    <div class="cost"><i class="fa fa-check"></i> Min $ {{App\Menu::where('restaurant_id', $restaurant->id)->min('price')}}</div>
                                    <div class="mins"><i class="fa fa-motorcycle"></i> {{$restaurant->deliverytime  }} min</div>
                                    <div class="ratings">
                                      <span>
                                        @for($i = 0; $i < App\Review::where('restaurant_id', $restaurant->id)->avg('star'); $i++)
                                          <i class='fa fa-star'></i>
                                        @endfor
                                        @for($i = 0; $i < (5 -App\Review::where('restaurant_id', $restaurant->id)->avg('star')); $i++)
                                          <i class="fa fa-star-o"></i>
                                        @endfor
                                      </span> ({{@count($restaurant->review)}}) </div>
                                </div>
                            </div>
                            <!-- end:col -->
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-5 join-text">
                        <p>Join the thousands of other restaurants who benefit from having their menus on <a href="#"><strong> IconFod</strong></a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-4 join-btn text-xs-right"><a href="{{ route('restaurant.register')}}" class="btn theme-btn btn-lg">I‘m restaurant</a> </div>
                </div>
            </div>
        </section>
        <!-- add restaurant ends -->
