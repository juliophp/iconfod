            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                      @guest
                          <li class="nav-item">
                              <a class="nav-link" href="#modalCart" data-toggle="modal" data-href="{{route('cart.get')}}">{{ __('Cart') }}
                      ...
                      @else
                          <li class="nav-item">
                              <a class="nav-link" data-toggle="modal" href="#modalCart" data-href="{{ route('cart.get') }}">{{ __('Cart') }}
                              <span class="badge">{{ Session::has('cart') ? Session::get('cart')->totalQty : ""}}</span></a>
                          </li>
